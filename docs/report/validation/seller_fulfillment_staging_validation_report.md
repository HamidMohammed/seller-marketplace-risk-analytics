...
These records represent orders that do not contain
associated seller fulfillment events.

Because seller attribution does not exist,
the pipeline cannot safely determine:

- seller geography
- seller/customer geographic relationship
- delivery distance classification

Therefore:
distance_bucket is intentionally classified as:

# Unknown

This represents:

# deterministic business missingness

rather than:

# random data corruption

The records are intentionally preserved to maintain:
